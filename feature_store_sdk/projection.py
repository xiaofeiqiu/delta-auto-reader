...
from .filters import FilterParser, BaseCondition, ConditionTuple
...
class FeatureSourceProjection:
    ...
    def __init__(
        ...
        join_type: str = "inner",
        where: Optional[Union[ConditionTuple, BaseCondition]] = None,
        ...
        Args:
            ...
            where: Filter conditions to apply to the source data.
                    Must be a ConditionTuple or BaseCondition using the c() helper function:
                    - Simple: c("age", ">", 25)
